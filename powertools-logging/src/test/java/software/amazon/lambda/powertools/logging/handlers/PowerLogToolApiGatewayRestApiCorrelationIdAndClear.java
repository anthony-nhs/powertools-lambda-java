...
public class PowerLogToolApiGatewayRestApiCorrelationIdAndClear implements RequestHandler<APIGatewayProxyRequestEvent, Object> {
    private final Logger LOG = LogManager.getLogger(PowerLogToolApiGatewayRestApiCorrelationId.class);

    @Override
    @Logging(correlationIdPath = API_GATEWAY_REST, clearState = true)
